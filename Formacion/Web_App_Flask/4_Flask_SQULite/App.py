...
if __name__ == '__main__':
    ...
    # En Synology cambiar host y puerto -> http://javicu.synology.me:5010/login  o  http://192.168.1.41:5010/login
    # app.run(host="javicu.synology.me", port=5010, debug=True)