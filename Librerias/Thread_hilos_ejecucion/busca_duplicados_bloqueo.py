...
# A partir de este tamaño crítico los archivos se leen por partes
...
def safe_print(lock, *args):
    #  Prevenir ejecución múltiples hilos escribiendo a la vez
    lock.acquire()
    print(*args)
    lock.release()
...
def process_file(path, filename, files, lock):
    ...
    try:
        ...
        # Obtener el hash MD5 del contenido y almacenarlo en el diccionario.
