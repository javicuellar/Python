...
import inquirer             # Simula menú con opciones que se elige con cursor, subiendo o bajando y enter
...
questions = [inquirer.List("authentication",                                # This is the key
...
if answers["authentication"] == "Login":
    print("Login")
    questions = [inquirer.Text("username",
